const translations = {
    en: {
        ...
        'privacy.p1': 'Fast Eleven is a single-player offline game. The app does not collect, store, or share any personal data. All game data is stored locally on your device and is never transmitted to any server.',
        ...
        'privacy.p3': 'The app does not use analytics, advertising, tracking, or any third-party services beyond crash reporting.',
        'privacy.p4': 'The app does not require an internet connection to function. No account or registration is needed.',

        // Support
        'support.title': 'Support',
        'support.intro': 'If you encounter any issues or have feedback, please reach out:',
    ...
    pt: {
        ...
        'privacy.p1': 'Fast Eleven é um jogo offline para um jogador. O app não coleta, armazena ou compartilha nenhum dado pessoal. Todos os dados do jogo são armazenados localmente no seu dispositivo e nunca são transmitidos para nenhum servidor.',
        ...
        'privacy.p3': 'O app não utiliza análises, publicidade, rastreamento ou quaisquer serviços de terceiros além do relatório de erros.',
        'privacy.p4': 'O app não requer conexão com a internet para funcionar. Nenhuma conta ou registro é necessário.',

        // Support
        'support.title': 'Suporte',
        'support.intro': 'Se você encontrar algum problema ou tiver feedback, entre em contato:',
